...
// Config
const REMOTE_VERSION_URL = `https://gitea.${domain}/api/v1/repos/fcord/fcord/releases/latest`;
...
async function checkForUpdates() {
    try {
        ...
        console.log(`[FcordUpdater] local=${localVersion} remote=${remoteVersion}`);
        ...
        console.error("[FcordUpdater] Error:", e);
    }
}
...
function UpdateBanner() {
    ...
    async function doUpdate() {
        ...
        try {
            ...
            console.error("[FcordUpdater] Update error:", e);
    ...
    return React.createElement("div", {
        ...
        React.createElement("div", {
            ...
            React.createElement("span", { style: { fontWeight: 700, flexShrink: 0 } },
                `Fcord ${info.remoteVersion} available!`
            ),
...
function mountBanner() {
    if (bannerContainer || document.getElementById("fcord-updater-root")) return;

    waitFor(["createRoot", "render"], (ReactDOM: any) => {
        if (bannerContainer || document.getElementById("fcord-updater-root")) return;
        bannerContainer = document.createElement("div");
        bannerContainer.id = "fcord-updater-root";
        ...
        try {
            ...
            console.error("[FcordUpdater] Error mounting banner:", e);
...
export default definePlugin({
    ...
    description: "Shows a banner when a new Fcord version is available. Click Update to install.",
