...
export default definePlugin({
    ...
    description: "Hides all plugin buttons without disabling them. Shortcut: Ctrl+Shift+H. The toggle is in Fcord Settings.",
    ...
    stop() {
        document.body.classList.remove("fcord-stealth");
    },
});
