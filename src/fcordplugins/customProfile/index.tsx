...
import { t } from "../autoTranslateFcord";
...
const LS_KEY_DATA = "FcordCP_data";
const LS_KEY_ENABLED = "FcordCP_enabled";
const DS_ALL_DATA = "customProfile_allData";
const DS_ALL_ENABLED = "customProfile_allEnabled";
const LS_ALL_DATA = "FcordCP_allData";
const LS_ALL_ENABLED = "FcordCP_allEnabled";
        ...
        <ModalRoot {...rootProps} size="medium">
            ...
            <ModalContent className="cp-content">
                <Toggle
                    ...
                    sublabel={t("Lets other Fcord users see your Custom Profile, and lets you see theirs")}
                ...
                <div style={{
                    ...
                    <span style={{ color: "var(--text-warning, #faa61a)", fontSize: 13, lineHeight: 1.4 }}>
                        {t("This requires Discord authorization. Once enabled, everyone using Fcord will be able to see your Custom Profile, and you will be able to see theirs.")}
                    </span>
                </div>
