...
export default definePlugin({
    name: "UserAreaTweaks",
    description: "Creates an elegant floating dock for Fcord plugins using pure CSS, preventing overlap and crashes.",
    authors: [{ name: "Fcord", id: 0n }],
    enabledByDefault: true,

    start() {
        const style = document.createElement("style");
        style.id = "fcord-userarea-tweaks-style";
        style.textContent = CSS;
        document.head.appendChild(style);
    },

    stop() {
        document.getElementById("fcord-userarea-tweaks-style")?.remove();
    }
});
