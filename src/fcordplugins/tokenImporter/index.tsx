            ...
            for (const acc of rawAccounts) {
                ...
                if (tok.startsWith("dQw4w9WgXcQ:")) {
                    try {
                        ...
                        console.error("[Fcord] decyption failed for ", acc.username, e);
                    }
                }
...
export default definePlugin({
    ...
    start() {
        addHeaderBarButton("fcord-token-importer", () => <TokenImporterButton />, 10);
    ...
    stop() {
        removeHeaderBarButton("fcord-token-importer");
