...
// through the cracks: window.__fcordPCLReset()
...
export default definePlugin({
    ...
    authors: [{ name: "arg0NNY (ported by Fcord)", id: 0n }],
    settings,
    ...
    async start() {
        ...
        (window as any).__fcordPCLReset = () => forceReset("manually triggered via window.__fcordPCLReset()");
    ...
    stop() {
        ...
        clearTimeout(autolockTimeout);
        clearTimeout(watchdogTimeout);
        delete (window as any).__fcordPCLReset;
