...
// Fcord native defaults — no external prefs file, always on
const FCORD_PREFS = { defaultPlugins: true, autoUpdate: true } as const;

export const installerPrefs = FCORD_PREFS;

handle(IpcEvents.GET_INSTALLER_PREFS, () => FCORD_PREFS);
