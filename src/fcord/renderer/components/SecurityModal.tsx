...
import { Button, Flex, Heading, Paragraph } from "@Fcord/types/components";
import { ModalContent, ModalFooter, ModalHeader, ModalRoot } from "@Fcord/types/utils";
            ...
            <ModalContent style={{ padding: "16px 24px" }}>
                    ...
                    <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                        ...
                        <li style={{ color: "var(--text-normal)" }}>
                            ...
                            <span
                                ...
                                onClick={() => VencordNative.native.openExternal("https://discord.gg/fcord")}
                            >
                                discord.gg/fcord
                            </span>
                        </li>
                ...
                <div style={{
                    ...
                    <Paragraph style={{ color: "var(--text-muted)", fontStyle: "italic", fontSize: "13px" }}>
                        <strong>Note:</strong> Only download FCordFr via our official channels to ensure your security.
                    </Paragraph>
                </div>
            </ModalContent>
