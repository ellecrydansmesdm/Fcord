...
import { Heading, Paragraph } from "@Fcord/types/components";
import { Margins } from "@Fcord/types/utils";
import { Select } from "@Fcord/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind Fcord for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
