...
import { classNameFactory } from "@Fcord/types/api/Styles";
import { BaseText, Divider, ErrorBoundary } from "@Fcord/types/components";
...
const SettingsOptions: Record<string, Array<BooleanSetting | SettingsComponent>> = {
    ...
    "User Interface": [
        ...
        },
        {
            key: "staticTitle",
            title: "Static Title",
            description: 'Makes the window title "Fcord" instead of changing to the current page',
            defaultValue: false
        },
        {
            key: "enableMenu",
        ...
        },
        {
            ...
            description:
                "Shows a small splash screen while Fcord is loading. Disabling this option will show the main window earlier while it's still loading.",
            defaultValue: true
        },
        {
            key: "splashTheming",
    ...
    Behaviour: [
        {
            key: "tray",
            title: "Tray Icon",
            description: "Add a tray icon for Fcord",
            defaultValue: true,
            invisible: () => isMac
        },
        {
            ...
            description: "Hitting X will make Fcord minimize to the tray instead of closing",
            defaultValue: true,
            invisible: () => isMac,
        ...
        },
        {
            ...
            description: "Left clicking tray icon will toggle the Fcord window visibility.",
            defaultValue: false
        },
        {
            key: "disableMinSize",
    ...
    Miscellaneous: [
        ...
        },
        {
            ...
            description: "Opens links in a new Fcord window instead of your web browser",
            defaultValue: false
        }
    ],
...
export default ErrorBoundary.wrap(
    ...
    {
        message:
            "Failed to render the Fcord Settings tab. If this issue persists, try to right click the Fcord tray icon, then click 'Repair Fcord'. And make sure your Fcord is up to date."
    }
);
