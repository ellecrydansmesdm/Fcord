...
import { Button, Card, HeadingTertiary, Paragraph } from "@Fcord/types/components";
import { useAwaiter } from "@Fcord/types/utils";
...
export function OutdatedVesktopWarning() {
    ...
    return (
        <Card variant="warning" className={cl("updater-card")}>
            <HeadingTertiary>Your Fcord is outdated!</HeadingTertiary>
