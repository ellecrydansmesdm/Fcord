...
import { Logger } from "@Fcord/types/utils";
import { findLazy, onceReady } from "@Fcord/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@Fcord/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("FcordRPC", "#5865f2");
