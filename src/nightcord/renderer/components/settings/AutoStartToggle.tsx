...
import { useState } from "@Nightcord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start Nightcord on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start Nightcord minimized when starting with system"}
