        ...
        <SettingsTab>
            ...
            <div className={Margins.bottom8}>
                <SearchableSelect
                    ...
                    closeOnSelect={true}
                    renderOptionPrefix={o => o?.value?.includes("fcord") ? <FcordIcon /> : o?.value?.includes("equicord") ? <EquicordIcon /> : <VencordIcon />}
                />
            </div>
