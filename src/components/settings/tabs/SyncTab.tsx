...
const cloudBackendOptions = [
    { label: "Fcord Cloud", value: "https://api.fcord.st/" },
...
const BADGE_OPTIONS: Array<{ label: string; value: BadgeSource }> = [
    { label: "Fcord Badges", value: "fcord" },
        ...
        <div style={{ marginBottom: 16 }}>
            <FormSwitch
                ...
                description={isEnabled
                    ? t("Your custom profile is synced. Other Fcord users can see your profile, and you can see theirs.")
                    : t("Enable to share your custom profile with other Fcord users and see their profiles.")}
                disabled={busy}
            />
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom16}>
                {t("Fcord's cloud integration allows you to sync your settings across multiple devices and Discord installations. Your data is securely stored and can be easily restored at any time.")}
            </Paragraph>

            <Notice.Info className={Margins.bottom16}>
                {t("We use our own Fcord Cloud backend with enhanced features.")}
                {" "}
            ...
            <div className={Margins.bottom8}>
                <SearchableSelect
                    ...
                    renderOptionPrefix={o => {
                        if (o?.value?.includes("fcord")) return <FcordIcon />;
            ...
            <Paragraph className={Margins.bottom16}>
                {t("Synchronize your Fcord settings to the cloud. This makes it easy to keep your configuration consistent across multiple devices without manual import/export.")}
            </Paragraph>
