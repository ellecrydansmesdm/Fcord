# ==============================================================================
#  Fcord — Désinstalleur utilisateur (PowerShell)
#  Supprime l'injection Fcord de Discord
#
...
$InstallDir    = Join-Path $env:LOCALAPPDATA "Fcord-Client"
...
Write-Host "  ║      FCORD — Désinstalleur           ║" -ForegroundColor Cyan
Write-Host "  ╚══════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  │  Fcord désinstallé avec succès !                 │" -ForegroundColor Green
